...
public class PlayerController : MonoBehaviour
{
    ...
    {
        Vector3 targetPosition = _playerTransform.position + new Vector3(LastInputVector.x + 0.5f, LastInputVector.y +0.5f, 0);
    ...
    {
        return mapDataController.ConvertGridPosition(new Vector2Int(Mathf.RoundToInt(transform.position.x + 0.5f), Mathf.RoundToInt(transform.position.y +0.5f)));
    }
}*/
